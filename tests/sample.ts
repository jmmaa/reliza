import { calculateAll, statMap } from "../src";
import {
  mainWeaponElement,
  subWeaponElement,
  totalPercentAGI,
} from "../src/modules/stats";
import { flattenedStats } from "../src/modules/utils";
import { wizardSkillsLearned } from "../src/modules/wizardSkills/castMastery";
...
const myConfig: Config = {
  ...
  "character.subweapon.ATK": 194,
  "character.subweapon.DEF": 15,
  "character.subweapon.refinement": 0,
  "character.subweapon.stability": 0,
  "character.subweapon.stats": [[StatId.lightElement, 1]],
...
console.log(calculateAll(myConfig));
