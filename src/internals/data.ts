...
export interface IntermediateConfig {
  ...
  [ParamId.CHARACTER_MAINWEAPON_STATMAP]: Stat[];
  [ParamId.CHARACTER_MAINWEAPON_CRYSTAL1_STATMAP]: Stat[];
  [ParamId.CHARACTER_MAINWEAPON_CRYSTAL2_STATMAP]: Stat[];
  ...
  [ParamId.CHARACTER_SUBWEAPON_STATMAP]: Stat[];
  [ParamId.CHARACTER_SUBWEAPON_CRYSTAL1_STATMAP]: Stat[];
  [ParamId.CHARACTER_SUBWEAPON_CRYSTAL2_STATMAP]: Stat[];
  ...
  [ParamId.CHARACTER_ARMOR_STATMAP]: Stat[];
  [ParamId.CHARACTER_ARMOR_CRYSTAL1_STATMAP]: Stat[];
  [ParamId.CHARACTER_ARMOR_CRYSTAL2_STATMAP]: Stat[];

  [ParamId.CHARACTER_ADDITIONAL_GEAR_DEF]: number;
  [ParamId.CHARACTER_ADDITIONAL_GEAR_REFINEMENT]: number;
  [ParamId.CHARACTER_ADDITIONAL_GEAR_STATMAP]: Stat[];
  [ParamId.CHARACTER_ADDITIONAL_GEAR_CRYSTAL1_STATMAP]: Stat[];
  [ParamId.CHARACTER_ADDITIONAL_GEAR_CRYSTAL2_STATMAP]: Stat[];

  [ParamId.CHARACTER_SPECIAL_GEAR_DEF]: number;
  [ParamId.CHARACTER_SPECIAL_GEAR_STATMAP]: Stat[];
  [ParamId.CHARACTER_SPECIAL_GEAR_CRYSTAL1_STATMAP]: Stat[];
  [ParamId.CHARACTER_SPECIAL_GEAR_CRYSTAL2_STATMAP]: Stat[];
