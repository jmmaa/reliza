...
export const defaultDeclaredStatusMap: DeclaredStatusMap = {
  ...
  hassoHappaLevel: 0,
  tenryuRanseiLevel: 0,
  kasumisetsuGetsukaLevel: 0,
  garyouTenseiLevel: 0,
  shadowLessSlashLevel: 0,
  pommelStrikeLevel: 0,
  magadachiLevel: 0,
  zanteiSettetsuLevel: 0,
  bushidoLevel: 0,
  shukuchiLevel: 0,
  nukiuchiSennosenLevel: 0,
  twoHandedLevel: 0,
  meikyouShisuiLevel: 0,
  kairikiRanshinLevel: 0,
  dauntlessLevel: 0,
  bouncingBladeLevel: 0,

  // dual sword skills
  dualSwordMasteryLevel: 0,
  twinSlashLevel: 0,
  spinningSlashLevel: 0,
  phantomSlashLevel: 0,
  aerialCutLevel: 0,
  crossParryLevel: 0,
  chargingSlashLevel: 0,
  shadowStepLevel: 0,
  shiningCrossLevel: 0,
  lunarMisfortuneLevel: 0,
  twinBusterBladeLevel: 0,
  reflexLevel: 0,
  flashBlastLevel: 0,
  flashBlastIsActive: false,
  stormReaperLevel: 0,
  dualSwordControlLevel: 0,
  godspeedLevel: 0,
  saberAuraLevel: 0,
  crescentSaberLevel: 0,
