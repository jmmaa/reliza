...
export type StatsFunc = (character: Character) => StatMap;

export type SubWeapon = (character: Character) => {
  type: SubWeaponType;
  ATK: number;
  DEF: number;
  refinement: number;
...
export type AdditionalGear = (character: Character) => {
  DEF: number;
  refinement: number;
  stats: StatMap;
  crystals: StatMap[];
...
export type Armor = (character: Character) => {
  DEF: number;
  refinement: number;
  type: ArmorType;
  stats: StatMap;
...
export type SpecialGear = (character: Character) => {
  DEF: number;
  stats: StatMap;
  crystals: StatMap[];
};

export type Crystal = StatMap[][];
